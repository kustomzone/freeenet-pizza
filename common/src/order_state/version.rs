...
mod tests {
    ...
    fn test_version_verify_accepts_current() {
        ...
        let parent = FullOrderStateV1::default();
...
/*
    ...
    fn test_state_without_version_field_deserializes_with_default() {
        ...
        use crate::order_state::configuration::{AuthorizedConfigurationV1, Configuration};
        ...
        let deserialized: FullOrderStateV1 = serde_json::from_str(&legacy_json).unwrap();
        assert_eq!(
    ...
    fn test_state_with_version_field_roundtrips() {
        ...
        let deserialized: FullOrderStateV1 = serde_json::from_str(&json).unwrap();
