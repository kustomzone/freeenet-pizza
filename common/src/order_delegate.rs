...
/// Messages sent from the App to the Order Delegate
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum OrderDelegateRequestMsg {
...
pub struct OrderDelegateKey(pub Vec<u8>);

impl OrderDelegateKey {
...
/// Responses sent from the Order Delegate to the App
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum OrderDelegateResponseMsg {
